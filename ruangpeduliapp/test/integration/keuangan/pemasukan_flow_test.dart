...
void main() {
  testWidgets('Pemasukan flow basic test', (WidgetTester tester) async {
    ...
    if (fields.evaluate().isNotEmpty) {
      await tester.enterText(fields.first, '50000');
      await tester.pump();
    }

    if (fields.evaluate().length >= 2) {
      await tester.enterText(fields.at(1), 'Test pemasukan');
      await tester.pump();
    }
